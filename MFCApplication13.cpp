...
// MFCApplication13.cpp: определяет поведение классов для приложения.
//
...
// Единственный объект CMFCApplication13App

CMFCApplication13App theApp;


// Инициализация CMFCApplication13App
